...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': { roles: ['business-owner', 'fleet-manager'], key: 'order', tenantPath: [], userPath: [] },
  'VehicleMaintenance.update': {
    roles: ['business-owner', 'fleet-manager'],
    key: 'vehicle',
    tenantPath: [],
    userPath: [],
  },
  'DeliveryCompleted.update': {
    roles: ['business-owner', 'fleet-manager', 'end-customer'],
    key: 'delivery',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'fleet-manager', 'end-customer'];
