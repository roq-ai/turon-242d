  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Turon - your gateway to a fleet of rental cars, conveniently available for the people nearby. Experience seamless car renting like never before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1568288564902-dead3b6fe60c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZW50YWwlMjBjYXJzfGVufDB8fHx8MTY5Njg1ODg0NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Turon - your gateway to a fleet of rental cars, conveniently available for the people nearby. Experience seamless car renting like never before.`}
            </Text>
            <Box
